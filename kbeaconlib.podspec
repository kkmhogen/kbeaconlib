...
Pod::Spec.new do |s|
  s.name             = 'kbeaconlib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of kbeaconlib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hogen/kbeaconlib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hogen' => 'liushax@gmail.com' }
  s.source           = { :git => 'https://github.com/hogen/kbeaconlib.git', :tag => s.version.to_s }
